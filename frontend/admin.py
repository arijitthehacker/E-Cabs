...
class BookingModelAdmin(admin.ModelAdmin):
    list_display = ['customer_name', 'booking_start_date','journey_date','pickup', 'destination', 'is_approved']
    ...
    def email_customers(self, request, queryset):
        for booking in queryset:
            if booking.is_approved:
                email_body = """Dear {},
    We are pleased to inform you that your booking has been approved. Booking Date: {}, Journey Date: {}, Pickup Location: {}, Destination: {}
Thanks
""".format(booking.customer_name,booking.booking_start_date,booking.journey_date,booking.pickup,booking.destination)
            else:
                email_body = """Dear {},
